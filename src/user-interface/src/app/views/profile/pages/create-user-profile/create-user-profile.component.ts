...
export class CreateUserProfileComponent implements OnInit, AfterViewInit, AfterContentInit {
  ...
  teachingmusicdropdownList = [
    { item_id: 1, item_text: 'Engineering' },
  ...
  ngOnInit() {
    this.userProfile = new FormGroup({
      ...
      devselectedItems: new FormControl([]),
      businessselectedItems: new FormControl([]),
      financeselectedItems: new FormControl([]),
      itdevselectedItems: new FormControl([]),
      officeProddevselectedItems: new FormControl([]),
      persdevselectedItems: new FormControl([]),
      designselectedItems: new FormControl([]),
      marketingdselectedItems: new FormControl([]),
      lifestyleselectedItems: new FormControl([]),
      PhotographyselectedItems: new FormControl([]),
      healthdevselectedItems: new FormControl([]),
      musicdevselectedItems: new FormControl([]),
      teachingdevselectedItems: new FormControl([])
    });
